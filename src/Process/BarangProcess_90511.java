 ...
 */
package Process;
import Entity.Barang_90511;
import Entity.BarangTerdaftar_90511;
import java.util.Scanner;

public class BarangProcess_90511 extends Abstract_90511{
    private static Scanner input = new Scanner(System.in);
    private static Barang_90511[] barang = new Barang_90511[100];
    private static BarangTerdaftar_90511[] barangTerdaftar = new BarangTerdaftar_90511[100];
    public static int jumBarang = 0;

    public Barang_90511[] getBarang(){
        return barang;
    }
    public BarangTerdaftar_90511[] getBarangTerdaftar(){
        return barangTerdaftar;
    }
// Polymorphisme overloading
    public void insert(String nama, String harga, String merk, String jumlah){
        barang[jumBarang] = new Barang_90511(nama, harga, merk, jumlah);
    }

    public void insert(Barang_90511 barang, String kodeBarang){
        barangTerdaftar[jumBarang] = new BarangTerdaftar_90511(barang, kodeBarang);
